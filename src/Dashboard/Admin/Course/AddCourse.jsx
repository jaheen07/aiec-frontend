...
//         coverForm.append("image", insImage);
//         // Upload instructor Image
//         const inscoverResponse = await fetch(imageUploadUrl, {
//           method: "POST",
//           body: coverForm,
//         });

      
//         if (!inscoverResponse.ok) {
//           throw new Error("Instructor image upload failed");
//         }

//         const insimageResponse = await inscoverResponse.json();
//         const ins_image_url = insimageResponse.data.display_url;
