...
const Blog = () => {
  ...
  return (
    ...
    <div className="px-4 py-5 mx-auto mt-32 overflow-hidden md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 ">
      {/* Slider */}
      ...
      <Helmet>
        <meta name="description" content="Explore our AI blogs & articles based on latest trends and insights from industry & AI Experts. Learn and stay up-to-date with the rapidly evolving field of AI." />
        
        <meta name="keywords" content="AI, machine learning, data science, deep learning, artificial intelligence, blogs, latest trends, insights, industry experts, learning, up-to-date, technology, innovation, future, ai blog in bangla, ai blog in bengali" />

        <meta property="og:type" content="website" />
        <meta property="og:site_name" content=" AI Expert Career " />
        <meta property="og:title" content="AI Expert Career|Blogs" />
        <meta property="og:url" content="https://www.aiexpertcareer.com/blogs" />
