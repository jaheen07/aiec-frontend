...
const AllCourses = () => {
  ...
  const categories = [
    ...
    { category: "Artificial Intelligence",label: "Artificial Intelligence Courses" },
  ...
  return (
    <div className="px-3 mx-auto mt-32 md:w-4/5 max-w-7xl md:px-0">
      {/* Banner */}
      <noscript>
      ...
      <Helmet>
        ...
        <meta name="keywords" content="ai expert career,ai courses, data science course, ai career guideline,ML courses, data analysis course ,best ai course in bd, ai, ai expert, ai expert bd, ai consultancy in bangladesh , ai consultancy in bd" />
        
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content=" AI Expert Career " />
        <meta property="og:title" content="AI Expert Career|courses" />
        <meta property="og:url" content="https://www.aiexpertcareer.com/courses" />
