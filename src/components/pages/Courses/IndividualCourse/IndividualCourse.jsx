          ...
          <div className="fixed bottom-0 left-0 w-full max-h-[80vh] bg-white border shadow-lg z-10 overflow-y-auto">
            ...
            <div className="flex justify-center">
              { enrolled ?
                ...
                (courseType === "paid" ? 
                  <Link onClick={()=> document.getElementById("my_modal_5").showModal()} state={{ course, discountAmount, courseFee }} className="w-11/12 mb-2 text-white bg-black btn hover:bg-black hover:text-white">
                    Enroll Now <IoIosArrowForward/>
                  </Link> : 
                  (courseType === "free"? 
                    <Link to="/free-course" state={{ course, discountAmount, courseFee }} className="w-11/12 mb-2 bg-white btn-view-red">
                      Enroll Now <IoIosArrowForward/>
                    </Link>:""
                  )
                ) 
