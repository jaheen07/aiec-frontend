  ...
  return (
    <div className="mb-10">
      <div className="md:flex bg-[rgba(236,218,219,0.2)]">
        ...
        <div className="p-3 px-6 lg:w-2/3">
          <div className="grid-cols-2 gap-8 mt-2 md:grid">
            <div className="mt-8">
            ...
            <div className="mt-8">
              ...
              <dialog id={`${userinfo._id}`} className="modal">
                ...
                >
                  ...
                  <h3 className="mb-5 text-3xl font-semibold text-center uppercase">
                    Update Profile{" "}
                  </h3>
                  <div className="grid space-x-4 md:grid-cols-2">
                    <div className="mb-2">
                      ...
                      <input
                        ...
                        {...register("name")}
                        className="block w-full px-4 py-2 mt-2 bg-white border rounded-md text-red focus:border-red focus:ring-red focus:outline-none focus:ring focus:ring-opacity-40"
                      />
                    </div>
                    ...
                    <div
                      ...
                      >
                        <p className="text-lg ">{ errors.phone ?   <p className="text-sm text-red-500">{errors.phone.message}</p> : ""}</p>
                      </div>
