...
const AiConsultanProfile = () => {
  ...
  const check = /(<([^>]+)>)/gi;
  // const newString = summary.replace(check, " ");
      ...
      <Helmet>
        ...
        <meta
          ...
          content={`https://ai-expert.netlify.app/consultant/${displayName
            ...
            .replace(/\s+/g, "-")}`}
        ></meta>
        <meta name="description" content= { summary.replace(check," ").substring(0, 165) + " ..." }/>
        <meta name="keywords" content={`${displayName} ${workingWith}`} />
        
        <meta property="og:type" content="website" />
        <meta name="og:title" content={displayName} />
        <meta name="og:description" content={ summary.replace(check," ").substring(0, 165) + " ..." } />
        <meta name="og:image" content={photoURL} />
        {/* <link rel="canonical" href= {`localhost:5173${location.pathname}`} /> */}
      </Helmet>
      <div className="max-w-full px-4 py-2 mx-auto mt-32 md:max-w-full lg:max-w-screen-xl xl:max-w-screen-xl 2xl:max-w-screen-2xl md:px-24 lg:px-20 2xl:px-8">
